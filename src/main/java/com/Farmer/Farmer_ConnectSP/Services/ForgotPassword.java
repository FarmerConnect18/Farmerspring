...
public class ForgotPassword {
    ...
    @Autowired
    private JavaMailSender javamilsender;
    @Autowired
    private BCryptPasswordEncoder secutityobj;
    ...
    public EmailDTO updatepassword(EmailDTO emaildto) {
        ...
        if (emaildto.getRole().equals("farmer")) {
            ...
            farmobj.setPassword(secutityobj.encode(emaildto.getPassword()));
