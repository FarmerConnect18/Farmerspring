...
public class JunctionService {
    ...
    private final String folderName = "Farmer-Connet/Junction";
...
//        junobj.setImg2(imagename);
        Map imagedata = cloudservice.uploadimage(junctiondto.getImg1(), folderName);
        junobj.setImg1(imagedata.get("url").toString());

        imagedata = cloudservice.uploadimage(junctiondto.getImg2(), folderName);
        junobj.setImg2(imagedata.get("url").toString());
